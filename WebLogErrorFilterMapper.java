...
public class WebLogErrorFilterMapper extends MapReduceBase implements Mapper <LongWritable, Text, Text, IntWritable> 
{ 
	...
	{ 
		...
		String logEntryLine = value.toString(); // Compile regular expression for parsing input
